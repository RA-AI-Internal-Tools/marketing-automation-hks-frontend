      ...
      <div class="bg-white rounded-xl border border-gray-200/80 shadow-sm p-6 space-y-4">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input v-model="name" required class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-[#0099db]/40 focus:ring-[#0099db]/40" />
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Template Key</label>
            <input v-model="templateKey" required class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-[#0099db]/40 focus:ring-[#0099db]/40" placeholder="e.g. welcome_email" />
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Channel</label>
            <select v-model="channel" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-[#0099db]/40 focus:ring-[#0099db]/40">
        ...
        <div v-if="channel === 'email'">
          ...
          <input v-model="subject" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-[#0099db]/40 focus:ring-[#0099db]/40" placeholder="Email subject line" />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows="8"
            class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-[#0099db]/40 focus:ring-[#0099db]/40 font-mono"
