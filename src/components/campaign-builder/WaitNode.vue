...
<template>
  <div
    class="vf-node vf-node-wait rounded-lg border-2 bg-[var(--color-warning-soft)] dark:bg-amber-950/40 shadow-sm"
  ...
  >
    ...
    <div class="flex items-start gap-2 p-3">
      <div class="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded bg-white shadow-sm dark:bg-neutral-800">
        <PauseIcon class="h-4 w-4 text-[var(--color-warning-text)]" />
      </div>
      <div class="min-w-0 flex-1">
        <div class="flex items-center gap-1.5">
          <span class="text-[10px] font-semibold uppercase tracking-wide text-[var(--color-warning-text)] dark:text-amber-200">Wait</span>
